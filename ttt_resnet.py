...
class ResNetCifar(nn.Module):
    # stliu: set depth to default 26; change classes to num_classes
    def __init__(self, depth=26, width=1, num_classes=10, channels=3, norm_layer=nn.BatchNorm2d):
        ...
        self.avgpool = nn.AdaptiveAvgPool2d(1) # stliu: change to adaptive for different scale pictures
