...
def build_model(args, net):
	from ttt_utils.SSHead import ExtractorHead
	print('Building head...')
	if args.shared == 'none':
		args.shared = None
	if args.shared == 'layer3' or args.shared is None:
		from ttt_utils.SSHead import extractor_from_layer3
		ext = extractor_from_layer3(net)
		head = nn.Linear(64 * args.width, 4)
	elif args.shared == 'layer2':
		from ttt_utils.SSHead import extractor_from_layer2, head_on_layer2
