...
def parse_option(): # design a function for parse
    ...
    # stliu: new options
    parser.add_argument('--results', default='./', help='the folder to save models')
    ...
    if not os.path.isdir(opt.results):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if not args.multiprocessing_distributed or (args.multiprocessing_distributed
            ...
            if epoch % args.save_freq == 0:
                ...
                }, is_best=False, filename=args.results + '/checkpoint_{:04d}.pth.tar'.format(epoch))
